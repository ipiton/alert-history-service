#!/usr/bin/env python3
"""
Тест для нового режима transparent_with_recommendations
"""
...
def test_transparent_recommendations_mode():
    """Тестирует новый режим transparent_with_recommendations"""

    print("🧪 Тестирование режима transparent_with_recommendations")
    print("=" * 60)
    ...
    if response.status_code == 200:
        ...
        if classification_results:
            ...
            print("   ⚠️  Нет результатов классификации (возможно, LLM недоступен)")
    else:
...
if __name__ == "__main__":
    test_transparent_recommendations_mode()
